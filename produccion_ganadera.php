...
<html lang="en">
  <head>
    <title>Producción Ganadera</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    $resultado = $conexion->query("SELECT * FROM publicaciones WHERE tipo='produccion_ganadera' ORDER BY idpublicaciones DESC LIMIT 5") or die($conexion);
